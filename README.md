...
6. Choose whether you want to use a database:
   ...
   Keep in mind, on default there is a cleanup job activated, which will delete all exercises that no client was connected to for 4 weeks. You can change this setting in the `./.env` file you copied
