...
- Add possibility to export only templates from an excercise and import them in another one.
    - Patients, vehicles, and images templates can be selected.
    - Imports can either overwrite existing templates or be added to the excercise.
