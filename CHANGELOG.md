...
- In the patient popup, there is a now a tab with a QR Code of the patient identifier. Trainers also
  can set custom QR code contents for each patient to support complexer systems.
