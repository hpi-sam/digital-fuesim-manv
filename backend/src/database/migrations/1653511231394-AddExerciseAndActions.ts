...
export class AddExerciseAndActions1653511231394 implements MigrationInterface {
    name = 'AddExerciseAndActions1653511231394'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "action_wrapper_entity" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "emitterId" uuid, "created" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "actionString" json NOT NULL, "exerciseId" uuid NOT NULL, CONSTRAINT "PK_d2a88101a67c9fc3be6590969d5" PRIMARY KEY ("id"))`);
