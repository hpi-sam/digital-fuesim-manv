...
export class AddExerciseAndActions1651697636183 implements MigrationInterface {
    name = 'AddExerciseAndActions1651697636183'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "action_emitter" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "emitterId" uuid NOT NULL, "emitterName" character varying(255), "exerciseId" uuid NOT NULL, CONSTRAINT "UQ_b4c749cf01f7433d57e9c896d6f" UNIQUE ("emitterId"), CONSTRAINT "PK_184934fb277f88f0dc5f797db0f" PRIMARY KEY ("id"))`);
